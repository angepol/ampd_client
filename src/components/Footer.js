...
const Footer = () => {
  ...
  return (
    <Box>
      ...
      >
        Ampd : a global parking company, which helps electronic car drivers find
        parking spaces.
      </h1>
      <Container>
        <Row>
          <Column>
            ...
            <FooterLink href="#" onClick={() => navigate("/signup")}>
              SignUp
            </FooterLink>
        ...
        <p style={{ color: "white", textSize: "15px" }}>
          {" "}
          ©️ Made by Tracey, Natalia, Angie & Kundai, 2021{" "}
        </p>
      </Container>
    </Box>
  );
